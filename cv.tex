...
\begin{multicols}{2}
 \begin{flushleft}
Room 3101, National Center for Supercomputing Applications\\
...
Email: \href{mailto:a.jyn@illiois.edu}{jyn@illinois.edu}\\[.1cm]
\textsc{url}: \href{http://sites.google.com/site/yinjunjun}{http://sites.google.com/site/yinjunjun}
\end{flushright}
\end{multicols}
...
Urban Complexity and Human Mobilities; Geo-Computing and Spatial Interaction  (High performance, Web and Mobile GIS)

%\hrule
\section*{Education}
\noindent
\years{2009 - 2013}\textit{Ph.D} in Spatial Information Science, Dublin Institute of Technology, Ireland\\
\textit{Dissertation: Mobile 2D and 3D Spatial Query Techniques for the Geospatial Web}\\
...
\textit{Dissertation:The topological patterns of urban street networks: Exploring the topological patterns of urban street networks from analytical and visual perspectives}\\
...
\noindent
\years{2016-now}Lecturer, University of Illinois at Urbana-Champaign, USA\\
\years{2014-now}Postdoctoral research associate, University of Illinois at Urbana-Champaign, USA\\
...
\years{2016}\textbf{Yin, J.}, Soliman, A., Yin, D. and Wang, S. (2016). Delineate urban boundaries in Great Britain from the network of large scale Twitter user spatial interactions \emph{\textbf{submitted, in revision} to International Journal of Geographical Information Science}\\
\years{2016}\textbf{Yin, J.} (2016). Exploring multi-level spatiotemporal Twitter user mobility patterns with a scalable visual-analytic framework \emph{\textbf{submitted} to Cartography and Geographic Information Science (CaGIS)}\\
\years{2016}Soliman, A.*, \textbf{Yin, J.*}, Soltani, K., Padmanabhan, A., and Wang, S. (2016). Semantic integration of geo-located Twitter with authoritative landuse maps. \emph{\textbf{submitted} to PLOS One}, *equal contribution\\

\subsection*{Journals}
\noindent
\years{2016}Jiang, B., Ma, D., \textbf{Yin, J.} and Sandberg, M. (2016). Spatial Distribution of Tweet Numbers and Densities in Cities. \emph{ Geographical Analysis, DOI: 10.1111/gean.12096}\\
\years{2015}Jiang, B.,\textbf{Yin, J.} and Liu, Q. (2015). Zipf's Law for All the Natural Cities around the World. \emph{International Journal of Geographical Information Science,  29(3), pp. 498-522}\\
\years{2014}Jiang, B. and \textbf{Yin, J}. (2014). Ht-Index to Quantify the Fractal or Scaling Structure of Geographic Features. \emph{Annals of the Association of American Geographers}, pp. 1–12\\
\years{2013}\textbf{Yin, J.} and Carswell, J.D. (2013). Spatial Search Techniques for Mobile 3D Queries in Sensor Web Environments. \emph{ISPRS International Journal of Geo-Information} 2(1): pp.135-154\\
\years{2010} Carswell, J. D., \textbf{Yin, J.} and Gardiner, K. (2010). 3DQ: Threat Dome Visibility Querying on Mobile Devices \emph{GIM International}, 24(8)\\
\years{2010}Carswell, J.D., Gardiner, K. and \textbf{Yin, J.} (2010). Mobile Visibility Querying for LBS. \emph{Transactions in GIS}, 14(6): pp. 791-809, Wiley online library\\
\years{2009}Jiang, B., \textbf{Yin, J.} and Zhao, S. (2009). Characterizing the human mobility pattern in a large street network. \emph{Physical Review E}, 80(2), 021136\\
\years{2008}Jiang, B., Zhao, S. and \textbf{Yin, J.} (2008). Self-organized natural roads for predicting traffic flow: a sensitivity study. \emph{Journal of statistical mechanics: Theory and experiment}, P07008, IOP Publishing

\subsection*{International conferences and lecture notes}
\noindent
...
\years{2016}Jeong, M., \textbf{Yin, J.}, Sullivan, C. and Wang, S. (2016). Robust statistical approaches to enhance spatial autocorrelation, \textit{The Ninth International Conference on Geographic Information Science (GIScience 16)}, Montreal, Canada. (Accepted)\\
...
\years{2016}\textbf{Yin, J.} and Wang, S. (2016). Mining Mobility Patterns From Semantic Twitter User Trajectories. The Association of American Geographers 112nd Annual Meeting, March 29 – April 2, 2016, San Francisco, California, USA\\
...
\years{2016 - } GEOG 479: Advanced Topics in GIS -- CyberGIS, Spring, 2016, \textit{course}, Department of Geography and Geographic Information Science, UIUC\\
\years{2015 - } Parallel Databases, \textit{workshop/short course}, CyberGIS Center, UIUC\\
...
\years{2015 - } Introducing the CyberGIS Toolkit in high performance computing environment, \textit{workshop/short course}, CyberGIS Center, UIUC\\
\years{2015 - } Taming with geospatial Big Data with Hadoop, \textit{workshop/short course}, CyberGIS Center, UIUC\\
\years{2014 - } Getting to know CyberGIS, \textit{workshop/short course}, CyberGIS Center, UIUC\\
\years{2014 - now} Education and outreach at the CyberGIS Commons, \textit{secretary}, University of Illinois at Urbana-Champaign, 2014 - now \\
\years{2013} Programming in C, \textit{senior demonstrator/assistant lecture}, Dublin Institute of Technology, 2013 - 2014\\
\years{2013} Object oriented programing for game development, \textit{senior demonstrator/assistant lecture}, Dublin Institute of Technology, 2013 - 2014\\
\years{2013} User interface design and GUI programing with Java, \textit{senior demonstrator/assistant lecture}, Dublin Institute of Technology, 2013 - 2014

\section*{Skills}
Programing languages:Java, Python, Objective-C, Matlab, R, JavaScript\\
...
Reviewer for GIScience 14 {2014}

%\hrule
\section*{Honors and awards}
\noindent
\emph{Fiosraigh Head of School Research Award}: for excellence in research, Dublin Institute of Technology\\
\emph{EU Future Internet Award}: for excellence in Future Internet research\\
\emph{PhD scholarship from Science Foundation Ireland (SFI)}: StratAG PhD scholarship\\
\emph{Outstanding Graduate Student Award}: University of Electronic Science and Technology of China\\
\emph{Best Undergraduate Dissertation Award}: Department of Electronic Engineering, University of Electronic Science and Technology of China\\
\emph{National Undergraduate Electronic Design Contest: Second prize}:Embedded system for Multi-channel and frequency wave generating, (Team: Yu Chen, Junjun Yin and Xia Yu)
