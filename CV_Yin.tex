...
\years{2022}Alba, C., Pan, B., \textbf{Yin, J.},  Rice, W., Lin, M.,  Liang, Y. and Mitra, P., COVID-19's impact on visitation behavior to US national parks from communities of color - evidence from mobile phone data. \textit{PLoS ONe} (forthcoming)\\
...
Reviewer for over \textbf{35} journals
%\begin{itemize}
%  \setlength\itemsep{0em}
