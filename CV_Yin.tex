...
\years{2023} \textbf{Yin, J.},  Brooks, M., Wang, D. and Chi, G., Characterizing Climate-Change Sentiment in Alaska with Twitter Data. (\textit{submitted to Environmental Communication})\\
\subsection*{Peer Reviewed Journals}
%\noindent
\years{2023}\textbf{Yin, J.} and Chi, G. (2023), A Tale of Three Cities: Uncovering human-urban interactions with geographic-context aware social media data. \textit{Urban Informatics} (forthcoming)\\
...
\subsection*{Data}
\noindent
\years{2020}Yin, J. Estimation of Twitter user demographics in the USA, 2014. \textit{Harvard Dataverse}, doi:10.7910/DVN/PKKAPK\\
...
\years{2021}Yin, J. (2021). Human-Urban Environment Interactions: A computational geography approache. October, 2021, Department of Geography, Pennsylvania State University, University Park, PA, USA\\
...
Reviewed articles from over \textbf{42} journals, such as Annals of the American Association of Geographers, International Journal of Geographical Information Science, and Applied Geography, etc.
%\begin{itemize}
%  \setlength\itemsep{0em}
