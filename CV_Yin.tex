...
\columnbreak
\begin{flushright}
Address: Room 309, Samson Hall\\
Phone: +1 217-819-6366\\[.1cm]
Email: \href{mailto:j.yin@gwu.edu}{j.yin@gwu.edu}\\[.1cm]
\textsc{url}: \href{https://yinjunjun.github.io}{www.junjunyin.com}
\end{flushright}
\end{multicols}
%%\hrule
...
GIScience; Geospatial Data Science; Geographic Big Data;
Human-Urban Interactions; Human Mobility; Urban Informatics; (Geo)Visual-Analytics; 
Spatial Data Mining and Deep Learning (GeoAI); Spatial/Graph Neural Networks; High-performance (cyberGIS), Web, and Mobile GIS\\
...
\textbf{PI}. ``Deep learning for Fine-grained Population Estimation in the Arctic Region''. Nvidia Academic Hardware Grant Program. Project dates: 06/01/2023—05/30-2024\\
\textbf{Co-PI}. ``RAPID: Using Mobile Phone Data to Understand the Impacts of the COVID-19 Pandemic on Food Assistance Use in Alaska''. NSF (National Science Foundation) SOC grant, $\$$200,000. Project dates: 02/01/2022—01/31-2025\\
...
\textsc{Online}: \href{https://scholar.google.com/citations?hl=en&user=LW01O2YAAAAJ&view_op=list_works&sortby=pubdate}{Google Scholar}
%\subsection*{Work in progress}
\subsection*{Submitted and In preparation}
\years{2026}Chi, G., \textbf{Yin, J.}, Van Hook,  J., Plutzer, E. and Xu, H., The Mis-representativeness of Twitter Data. (\textit{submitted to Demography, in review})\\


\subsection*{Peer Reviewed Journals}
%\noindent
\years{2026}Morris, L., Chi, G., \textbf{Yin, J.}, Bodovski, Y. and Sundar, S.S., County Partisanship Affects Engagement with X (Twitter) Over the Course of a Global Pandemic. \textit{Social media+ society, accepted}\\
\years{2025}Djenontin, I.N., Fischer, H.W., \textbf{Yin, J.} and Chi, G., 2025. Unveiling global narratives of restoration policy: Big data insights into competing framings and implications. \textit{Geoforum}, 161, p.104241. (DOI: 10.1016/j.geoforum.2025.104241)\\
\years{2025} \textbf{Yin, J.},  Brooks, M., Wang, D. and Chi, G., Characterizing Climate-Change Sentiment in Alaska with Twitter Data. \textit{Digital Geography and Society}, 8: 100110.  \\(DOI: 10.1016/j.diggeo.2024.100110)\\
\years{2025}\textbf{Yin, J.} Unlocking the Secrets of Scenic Beauty:  An artificial intelligence approach to understanding public perceptions of environmental aesthetics. \textit{Journal of the Royal Society Interface}, 22(225): 20250045. (DOI: 10.1098/rsif.2025.0045)\\
\years{2025}Sundar, S.S., Snyder, E., Liao, M., \textbf{Yin, J.}, Wang, J., and Chi, G., Sharing without clicking: The concerning phenomenon of mindless news forwarding on social media. \textit{Nature Human Behaviour}, 9(1), pp. 156-168. (DOI:10.1038/s41562-024-02067-4)\\
\years{2024}Chi, G., Zhou, S., Mucioki, M., Miller, J., Korkut, E., Howe, L., \textbf{Yin, J.} et al. "Climate impacts on migration in the Arctic North America: existing evidence and research recommendations." \textit{Regional Environmental Change}, 24(2): 47\\
\years{2023}\textbf{Yin, J.} and Chi, G. (2023), A Tale of Three Cities: Uncovering human-urban interactions with geographic-context aware social media data. \textit{Urban Informatics, 1(1), 20}\\(DOI:10.1007/s44212-022-00020-2)\\
...
\years{2022}Chi, G., \textbf{Yin, J.}, Morris, L., and Bodovski, Y., Global Tweet Mentions of COVID-19 (2022). \textit{Health Data Science}\\
...
\noindent
\years{2023}\textbf{Yin, J.} and Chi, G. (2023). Fine-grained Population Estimates: Infusing Deep Learning into Dasymetric Mapping of Buildings. \textit{2023 North American Meetings of the Regional Science Association Internationa}, San Diego, CA, November 15 -18, 2023\\
...
\subsection*{Data}
\noindent
\years{2020}\textbf{Yin, J.}. Estimation of Twitter user demographics in the USA, 2014. \textit{Harvard Dataverse}, doi:10.7910/DVN/PKKAPK\\

\subsection*{Invited talks}
\years{2024}Yin, J. (2024). Modeling Geo-Complexity in Human-Urban Interactions: Computational Geography meets Geographic Big Data. June 2024, Department of Geography, the University of Manchester, United Kingdom\\
\years{2024}Yin, J. (2024). A New Era of Urban Informatics: Multi-Layered Data Synthesis Approaches and Frameworks. June 2024, Department of Geography and Environmental Science, the University of Southampton, United Kingdom\\
\years{2023}Yin, J. (2023). Geographic Data Science: Spatial Data mining and machine learning with mobility Big Data. April, 2023, Department of Geography, the University of Liverpool, United Kingdom\\
\years{2022}Yin, J. (2022). A computational geography approach to understanding human-urban environment interactions. July 2022, Department of Land Surveying and Geo-Informatics (LSGI), the Hong Kong Polytechnic University, Hong Kong SAR, China\\
\years{2021}Yin, J. (2021). Human-Urban Interactions: A computational geography approach. October 2021, Department of Geography, Pennsylvania State University, University Park, PA, USA\\
\years{2020}Yin, J. (2020). Uncovering universal human activity patterns with geospatial big data: complexity, unity, and regularity. March 2020, Auburn University, Auburn, AL, USA\\
\years{2020}Yin, J. (2020). Computational Social Sciences: spatial interactions and geo-complexity. February 2020, University of Arkansas, Fayetteville, AR, USA\\
\years{2019}Yin, J. (2019). Spatial Networks: A computational geography approach to new insights into spatial interactions and geo-complexity. January 2019, University of Florida, Gainesville, FL, USA\\
...
\section*{Teaching/Instructing}
\years{2026} Data Visuliaztion for Data Science (DATS 2102),  \textit{Lecturer}, George Washington University\\
\years{2026} Data Science Capstone  (DATS 6501),  \textit{Lecturer}, George Washington University\\
\years{2025} Data Visuliaztion for Data Science (DATS 2102),  \textit{Lecturer}, George Washington University\\
\years{2024} Stochastic Modeling and Computation (SMAC series): Geographic Data Science,  \textit{Guest lecturer}, Penn State\\
\years{2023} SoDA501 : Social Data Analytics, Spring, \textit{Guest lecturer}, Penn State\\
\years{2022} Quantitative Developmental Systems Methodology (QuantDev Series): Machine learning/Deep learning for text analysis in social science applications, \textit{Guest lecturer}, Penn State\\
\years{2021-} Spatial Networks, \textit{lecturer}, Penn State\\
\years{2017-} Computational Social Sciences: data, methods, and applications, \textit{lecturer}, Penn State\\
...
\section*{Mentorship}
\years{2023} Project: Mobility Big Data for studying return migrations amid natural disasters and environmental change. Ph.D student: Yining Feng\\
\years{2023} Drawdown (Climate Change) Scholar mentor. Project: Geospatial Analysis of Socioeconomic Factors Impacting Electric Vehicle Charging Station Accessibility. Student: Fazil Farhan Iqbal\\
\years{2022} Project: Exploring national park visitor dynamics with Location Based Social Media and Mobile Location Data. Ph.D student: Yun Liang (Currently Teaching Assistant Professor at Kansas State University)\\
\years{2021} Capstone program mentor. Project: Assessing the impact of the COVID-19 pandemic on national park visitor patterns with model-driven approaches and mobility Big Data. Undergraduate student: Charles Alba (Currently Ph.D student at the Washington University in St Louis)\\

%\hrule
\section*{Skills}
\textbf{Programing languages}: Python, R, Java, Objective-C, Matlab, JavaScript, NoSQL\\
\textbf{Neural nets}: ResNet, U-net, Convolutional Neural Networks, Graph Neural Networks\\
\textbf{High performance computing (HPC)}: Hadoop, Spark, MongoDB\\
\textbf{Mobile and web geo-visualization}: iOS and Android, Cesium 3D Globe, D3.js\\
\textbf{Spatial databases}: PostGIS, Oracle Spatial, SpatiaLite, ArcGIS
...
\begin{itemize}
\item{\textbf{Editorial board member} Journal of Geography and Cartography}
\item{\textbf{Topic editor} Geosciences}
\item{\textbf{Guest editor} Special Issue of ``Spatial Demography``:  Big Spatial Data in Demography (2023)}
\item{\textbf{Guest editor} Special Issue of ``Chinese Sociological Dialogue``: Spatiotemporal Big Data and Sustainable Social Development (2017)}
\end{itemize}
...
%\begin{itemize}
%  \setlength\itemsep{0em}
%  \item \emph{Annals of the American Association of Geographers} 
%  \item \emph{International Journal of Geographical Information Science (IJGIS)}
%  \item \emph{Journal of Geographical Sciences} 
%  \item \emph{Applied Geography}
%  \item \emph{Journal of Geovisualization and Spatial Analysis} 
%  \item \emph{Cartography and Geographic Information Science} 
%  \item \emph{Computers, Environment and Urban Systems (CEUS)}
%  \item \emph{Journal of Urban Technology}
%  \item \emph{Transactions on Intelligent Transportation Systems}
%  \item \emph{EPJ Data Science}
%  \item \emph{Geomatica}
%  \item \emph{GeoJournal}
%  \item \emph{Chinese Sociological Dialogue}
%  \item \emph{Spatial Information Research}
%  \item \emph{Sensors}
%  \item \emph{Geographical Analysis}
%  \item \emph{Cluster Computing}
%  \item \emph{Journal of Geographical Systems} 
%  \item \emph{Demography}
%  \item \emph{Environment and Planning B: Planning and Design}
%  \item \emph{Science China Information Science}
%  \item \emph{PLOS One}
%  \item \emph{Cities} (2014)
%  \item \emph{ISPRS International Journal of Geo-Information}
%  \item \emph{Electronics}
%  \item \emph{Journal of Location Based Services}
%\end{itemize} 
