...
\years{2016} Gao, Y., Wang, S. Padmanabhan, A., \textbf{Yin, J.} and Guo, C. Mapping Spatiotemporal Patterns of Events Using Social Media: A Case Study of Influenza Trends. \emph{submitted to International Journal of Geographical Information Science, in revision}\\

\subsection*{Peer Reviewed Journals}
\noindent
\years{2016}\textbf{Yin, J.}, Soliman, A., Yin, D. and Wang, S. (2016). Delineate urban boundaries in Great Britain from the network of large scale Twitter user spatial interactions \emph{International Journal of Geographical Information Science}~(Accepted, forthcoming)\\
...
\years{2016}\textbf{Yin, J.} and Du, Z. (2016). Exploring Multi-Scale Spatiotemporal Twitter User Mobility Patterns with a Visual-Analytics Approach \emph{ISPRS International Journal of Geo-Information}, 5(10):187.\\
