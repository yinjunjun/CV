...
GIScience; Spatial Analysis and Modeling; Human-Urban Environment Interactions; Computational Geography;
Geo-Complexity and Human Mobility; Urban Computing; (Geo)Visual-Analytics; 
GeoSpatial Big Data and Data Mining; High-performance (cyberGIS), Web and Mobile GIS
...
\years{2021}Alba, C., Pan, B., \textbf{Yin, J.},  Rice, W., Lin, M.,  Liang, Y. and Mitra, P., COVID-19's impact on visitation behavior to US national parks from communities of color - evidence from mobile phone data. (\textit{submited to PNAS (Proceedings of the National Academy of Sciences of the United States of America)})\\
\years{2021}Chi, G., \textbf{Yin, J.}, Van Hook,  J., Plutzer, E. and Xu, H., The Mis-representativeness of Twitter Data. (\textit{submitted to Demography})\\
\years{2021}Zheng, K., \textbf{Yin, J.}, Liu, M., Zhang, M. and Xie, M., A joint neural network model for geographical entity relation extraction from Chinese texts. (\textit{submitted to Knowledge and Information Systems})\\
\years{2021} \textbf{Yin, J.} and Chi, G., Understanding Spatiotemporal Urban Activity Patterns: A GIS-based Data Synthesis Approach. (\textit{In preparation})\\
\years{2021} \textbf{Yin, J.},  Brooks, M., Wang, D. and Chi, G., Characterizing Climate-Change Sentiment in Alaska with Twitter Data. (\textit{In preparation})\\
\subsection*{Peer Reviewed Journals}
\noindent
\years{2022} \textbf{Yin, J.}, Gao, Y.. Chi, G. and Van Hook, J., An Evaluation of Geo-located Twitter Data for Measuring Human Migration. \textit{International Journal of Geographical Information Science} (forthcoming)\\
...
\years{2021}\textbf{Yin, J.} and  Chi, G., Characterizing People’s Daily Activity Patterns in the Urban Environment: A mobility network approach with geographic context-aware Twitter data. \textit{Annals of the Association of American Geographers}, pp.1-21\\
...
\noindent
\years{2022}Pan, B., Savanapelli, V., Shukla, A., \textbf{Yin, J.} (2022). Monitoring Human-Wildlife Interactions in National Parks with Crowdsourced Data and Deep Learning. \textit{ Proceedings of the ENTER 2022 eTourism Conference}, January 11-14, 2022 (\textit{$*$corresponding author})\\
...
\begin{itemize}
\item{\textbf{Topic editor} Geosciences, MDPI, (2020-2022)}
...
Has reviewed for \textbf{30} journals
\begin{itemize}
  \setlength\itemsep{0em}
