...
\years{2022}Chi, G., \textbf{Yin, J.}, Van Hook,  J., Plutzer, E. and Xu, H., The Mis-representativeness of Twitter Data. (\textit{In preparation})\\
\years{2022}Chi, G., \textbf{Yin, J.}, Morris, L., and Bodovski, Y., Global Tweet Mentions of COVID-19. \textit{In preparation}\\
\years{2022} \textbf{Yin, J.} and Chi, G., Understanding Spatiotemporal Urban Activity Patterns: A GIS-based Data Synthesis Approach. (\textit{In preparation})\\
...
\noindent
\years{2022}\textbf{Yin, J.}, Gao, Y. and Chi, G., An Evaluation of Geo-located Twitter Data for Measuring Human Migration. \textit{International Journal of Geographical Information Science} (accepted)\\
\years{2022}Alba, C., Pan, B., \textbf{Yin, J.},  Rice, W., Lin, M.,  Liang, Y. and Mitra, P., COVID-19's impact on visitation behavior to US national parks from communities of color - evidence from mobile phone data. \textit{PLoS One} (accepted)\\
\years{2022}Liang, Y., \textbf{Yin, J.},  Pan, B.,  Lin, M., Millerm, L., Taff, D., Chi, G., Assessing the Validity of Mobile Device Data for Estimating Visitor Demographics and Visitation Patterns in Yellowstone National Park. \textit{Journal of Environmental Management} (accepted)\\
