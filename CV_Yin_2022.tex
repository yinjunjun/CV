...
\years{2022}Liang, Y., \textbf{Yin, J.},  Pan, B.,  Lin, M., Millerm, L., Taff, D., Chi, G., Assessing the Validity of Mobile Device Data for Estimating Visitor Demographics and Visitation Patterns in Yellowstone National Park. (\textit{submited to Journal of Environmental Management, in revision})\\
\years{2022}Alba, C., Pan, B., \textbf{Yin, J.},  Rice, W., Lin, M.,  Liang, Y. and Mitra, P., COVID-19's impact on visitation behavior to US national parks from communities of color - evidence from mobile phone data. (\textit{submited to PLoS One})\\
